...
def generador_tabla(lista_funciones): #se activa en main
    """ [Autor: Augusto Carmona]
        [Ayuda: recibe la lista con los nombres de las funciones, las divide en una sola
        lista anidada y la envia al modulo tablas]
    """
    
    if lista_funciones <= 5:
        data = [lista_funciones]
    
    elif lista_funciones > 5:
        ...
        data = [columna_1, columna_2, columna_3, columna_4, columna_5] #data es la lista anidada que necesitamos para el modulo tablas

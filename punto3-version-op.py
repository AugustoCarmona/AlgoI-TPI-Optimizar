...
print(guiones_totales)
archivo.close()
#elif ("."+nombre_funcion+"(" in lista_merge[linea_2][dato_2] or " "+nombre_funcion+"(" in lista_merge[linea_2][dato_2] or "("+nombre_funcion+"(" in lista_merge[linea_2][dato_2] or "="+nombre_funcion+"(" in lista_merge[linea_2][dato_2]):
#if ("."+funcion+"(" in lista_merge[linea_2][dato_3] or " "+funcion+"(" in lista_merge[linea_2][dato_3] or "("+funcion+"(" in lista_merge[linea_2][dato_3] or "="+funcion+"(" in lista_merge[linea_2][dato_3]):
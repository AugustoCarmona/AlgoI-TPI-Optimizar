...
_El proyecto se inicializa desde "inicio.py".
_La carpeta "data" guarda datos necesarios para realizar el merge más adelante en el programa de inicio.
_El punto 1 está en el archivo "panel.py".
_El punto 2 está en el archivo "consulta.py".
_El punto 3 está en el archivo "analizador.py".
_El punto 4 está en el archivo "arbol.py".
